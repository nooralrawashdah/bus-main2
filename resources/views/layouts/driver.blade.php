...
<head>
    ...
    <title>{{ config('app.name', 'Driver Portal') }}</title>
    ...
    <style>
        ...
        /* Helper for transition effects on cards */
        .transition-hover {
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('driver.trips') }}">Trips</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('driver.bus') }}">My Bus</a>
                    </li>
